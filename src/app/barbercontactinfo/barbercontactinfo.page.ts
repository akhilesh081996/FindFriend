...
export class BarbercontactinfoPage implements OnInit {
  ...
  ngOnInit() {
    this.editform = new FormGroup({
      ...
      // 'price_per_hour': new FormControl('', Validators.compose([
      //   Validators.required
      // ])),
      'Political_Party': new FormControl('', Validators.compose([
        Validators.required
      ])),
      'Religion': new FormControl('', Validators.compose([
        Validators.required
      ])),
      'Dating_Preferences': new FormControl('', Validators.compose([
        Validators.required
      ])),
      'Do_you_read': new FormControl('', Validators.compose([
        Validators.required
      ])),
      'Do_you_watch_TV': new FormControl('', Validators.compose([
        Validators.required
      ])),
      'Do_you_have_kids': new FormControl('', Validators.compose([
        Validators.required
      ])),
      'Do_you_play_games': new FormControl('', Validators.compose([
        Validators.required
      ])),
      'Are_you_Shy': new FormControl('', Validators.compose([
        Validators.required
      ])),
      'Are_you_outgoing': new FormControl('', Validators.compose([
        Validators.required
      ])),
      'Are_you_Adventurous': new FormControl('', Validators.compose([
        Validators.required
      ])),
      'Do_you_have_a_sense_of_humor': new FormControl('', Validators.compose([
        Validators.required
      ])),
  ...
  RenderProfileData() {
    ...
    this.storage.get('user_profile').then(user_profile => {
      if (user_profile != null) {
        ...
        this.editform.controls['shop_phone'].setValue(this.user_profile.shop_phone);
        this.editform.controls['shop_email'].setValue(this.user_profile.shop_email);
        this.editform.controls['shop_address1'].setValue(this.user_profile.shop_address1);
        this.editform.controls['shop_address2'].setValue(this.user_profile.shop_address2);
        this.editform.controls['shop_city'].setValue(this.user_profile.shop_city);
        this.editform.controls['shop_state'].setValue(this.user_profile.shop_state);
        this.editform.controls['shop_zipcode'].setValue(this.user_profile.shop_zipcode);
        ...
        this.editform.controls['Political_Party'].setValue(this.user_profile.Political_Party);
        this.editform.controls['Religion'].setValue(this.user_profile.Religion);
        this.editform.controls['Marital_Status'].setValue(this.user_profile.Marital_Status);
        this.editform.controls['Do_you_have_a_sense_of_humor'].setValue(this.user_profile.Do_you_have_a_sense_of_humor);
        this.editform.controls['Are_you_Adventurous'].setValue(this.user_profile.Are_you_Adventurous);
        this.editform.controls['Are_you_outgoing'].setValue(this.user_profile.Are_you_outgoing);
        this.editform.controls['Are_you_Shy'].setValue(this.user_profile.Are_you_Shy);
        this.editform.controls['Dating_Preferences'].setValue(this.user_profile.Dating_Preferences);
        this.editform.controls['Do_you_play_games'].setValue(this.user_profile.Do_you_play_games);

        this.editform.controls['Do_you_read'].setValue(this.user_profile.Do_you_read);
        this.editform.controls['Do_you_watch_TV'].setValue(this.user_profile.Do_you_watch_TV);
        this.editform.controls['Are_you_Shy'].setValue(this.user_profile.Are_you_Shy);
        this.editform.controls['Do_you_have_kids'].setValue(this.user_profile.Do_you_have_kids);
        
        // this.editform.controls['price_per_hour'].setValue(this.user_profile.price_per_hour);
